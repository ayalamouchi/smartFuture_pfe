...
export class Footer {
  ...
  socialLinks = [
    ...
    { name: 'LinkedIn', icon: 'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z', url: '#' },
  ...
  quickLinks = [
    { label: 'Catalogue formations', url: '#catalogue' },
    { label: 'À propos', url: '#apropos' },
    { label: 'Examens Certiport', url: '#examens' },
